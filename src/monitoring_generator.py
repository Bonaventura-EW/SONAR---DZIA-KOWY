...
z OLX/Otodom, nowe/zaktualizowane oferty i stan bazy. Wzorowany na
monitoring_generator.py z SONAR-POKOJOWY, dostosowany do formatu scan_history
SONARA DZIAŁKOWEGO (płaskie wpisy z main.py::_log_scan).
"""
